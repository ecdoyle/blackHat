...
# BlackHat Files
#print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
f1txt = getFileText('md.txt') # moby dick
#print('File 1: ',f1txt)
f2txt = getFileText('pp.txt') # pride and prejudice
#print('File 2: ', f2txt)
f3txt = getFileText('al.txt') # alice in wonderland
#print('File 2: ', f3txt)
f4txt = getFileText('sher.txt') # sherlock holmes
#print('File 4: ', f4txt)
f5txt = getFileText('fr.txt') # frankenstein
#print('File 5: ', f5txt)
#print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
...
#multiBarChart('Single Character Frequency', unigramFreqs, f1SingleFreq, f2SingleFreq, f3SingleFreq, f4SingleFreq, f5SingleFreq)
